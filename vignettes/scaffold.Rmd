...
`estimateScaffoldParameters` function, which returns an object of
class `ScaffoldParams`.

```{r}
scaffoldParams <- estimateScaffoldParams(sce)
```
...
How to simulate multiple populations?

How to simulate continuous populations?
