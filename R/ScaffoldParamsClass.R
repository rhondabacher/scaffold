...
setMethod("show", signature(object = "ScaffoldParams"),
          function(object){
            ...
            cat("numPreAmpCycles:", object@numPreAmpCycles, "\n")
            cat("numAmpCycles:", object@numAmpCycles, "\n")
            cat("preAmpEfficiency:", head(object@preAmpEfficiency), "...\n")
            cat("ampEfficiency:", head(object@ampEfficiency), "...\n")
